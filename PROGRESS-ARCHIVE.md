# PROGRESS-ARCHIVE.md — shipped history before 2026-08-08

> **Sessions read `PROGRESS.md`, not this file — unless they are hunting
> history.** This is the tail of the build log: every entry here shipped, was
> verified, and is closed. It is kept verbatim because the SCARS are the value —
> several of these entries are the only written record of why a rule in
> `docs/ENGINEERING-WORKFLOW.md` exists.
>
> **Nothing was deleted, condensed or reworded moving here.** `PROGRESS.md`
> keeps the three newest ship entries plus every OPEN item, risk and decision;
> everything older lives below, newest first.
>
> Come here when you need to answer "why is it like this?" — and when you do,
> read the entry, not the summary.
